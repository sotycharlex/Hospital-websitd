...
<html lang="en">
  ...
  <a class="navbar-brand" href="#"> Sterling Hospital </a>
...
<body style="padding-top:50px;">
   <div class="container-fluid" style="margin-top:50px;">
    <h3 style = "margin-left: 40%;  padding-bottom: 20px; font-family: 'Open Sans', sans-serif;"> Welcome &nbsp<?php echo $doctor ?>
   </h3>
