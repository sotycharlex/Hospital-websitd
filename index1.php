...
<html lang="en">
  ...
  <body style="background: white; background-size: cover;">
    ...
    <div class="container">
      ...
      <a class="navbar-brand js-scroll-trigger" href="index.php" style="margin-top: 10px;margin-left:-65px;font-family: 'Open Sans', sans-serif;"><h4> Sterling Hospital</h4></a>
      <button class="navbar-toggler" type="button" data-toggle="collapse" data-target="#navbarResponsive" aria-controls="navbarResponsive" aria-expanded="false" aria-label="Toggle navigation">
        <span class="navbar-toggler-icon"></span>
      </button>
      <div class="collapse navbar-collapse" id="navbarResponsive">
        <ul class="navbar-nav ml-auto" style =background-color:#343148;>
    ...
    animation: mover 1s infinite alternate;">
      ...
      <div style="color: #343148;">
            <h4 style="font-family: 'Open Sans', sans-serif;"> We are here for you!</h4>
          </div>
